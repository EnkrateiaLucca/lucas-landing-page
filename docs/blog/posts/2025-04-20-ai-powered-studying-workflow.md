...
![](../assets/chatgpt-effort-learning.png)
...
??? note "Prompt for Quizzing with Quotes"
      ...
      **Rules**
      ...
      ```
      Example output:
      ![](../assets/quiz-with-quote-answer.png)
...
Informal (spoken) version
  Example from chat:
  ![](../assets/prompt-informal-explain-back.png)
...
![](../assets/micro-flow-general-chart.png)
*Image generated by me! :)*
...
![](../assets/automated-hypothesis-validation.png)
